...
(54, 'Giáo trình tiếng anh khoa học máy tính', 8, 60, 78000, 'Nhà xuất bản Ngoại ngữ', 'Quang Huy-Ngọc Ánh', 'image_sach/n6.jpg'),
(55, 'Tâm lý làm sáng của trẻ em Việt Nam', 10, 50, 34000, 'Nhà xuất bản kinh tế', 'Trần Thị Kim Yến', 'image_sach/t1.jpg'),
...
--
ALTER TABLE `hoadon`
 ADD PRIMARY KEY (`MaHoaDon`), ADD KEY `MaKhachHang` (`MaKhachHang`,`MaSach`), ADD KEY `MaSach` (`MaSach`);
...
--
ALTER TABLE `hoadon`
ADD CONSTRAINT `hoadon_ibfk_1` FOREIGN KEY (`MaSach`) REFERENCES `sach` (`MaSach`),
